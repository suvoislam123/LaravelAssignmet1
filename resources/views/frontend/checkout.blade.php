				...
				<div class="container">
					<div class="header-left">
						...
						<a href="demo1.html" class="logo">
							<img src="{{ asset('ui/frontend') }}/images/logo.png" alt="logo" width="153" height="44" />
						</a>
						<!-- End Logo -->
								...
								<div class="products scrollable">
									<div class="product product-wishlist">
										<figure class="product-media">
											<a href="product.html">
												<img src="{{ asset('ui/frontend') }}/images/wishlist/product-1.jpg" width="100" height="100"
													alt="product" />
											</a>
									...
									<div class="product product-wishlist">
										<figure class="product-media">
											<a href="product.html">
												<img src="{{ asset('ui/frontend') }}/images/wishlist/product-2.jpg" width="100" height="100"
													alt="product" />
											</a>
											<button class="btn btn-link btn-close">
												<i class="fas fa-times"></i><span class="sr-only">Close</span>
									...
									<div class="product product-wishlist">
										<figure class="product-media">
											<a href="product.html">
												<img src="{{ asset('ui/frontend') }}/images/wishlist/product-3.jpg" width="100" height="100"
													alt="product" />
											</a>
											<button class="btn btn-link btn-close">
												<i class="fas fa-times"></i><span class="sr-only">Close</span>
									...
									<div class="megamenu">
										<div class="row">
											...
											<div
												...
												<figure>
													<img src="{{ asset('ui/frontend') }}/images/menu/banner-1.jpg" alt="Menu banner" width="221"
														height="330" />
												</figure>
									...
									<div class="megamenu">
										<div class="row">
											...
											<div
												...
												<figure>
													<img src="{{ asset('ui/frontend') }}/images/menu/banner-2.jpg" alt="Menu banner" width="221"
														height="330" />
												</figure>
					...
					<div class="row align-items-center">
						<div class="col-lg-3">
							<a href="demo1.html" class="logo-footer">
								<img src="{{ asset('ui/frontend') }}/images/logo-footer.png" alt="logo-footer" width="154" height="43" />
							</a>
							<!-- End FooterLogo -->
						</div>
						<div class="col-lg-9">
						...
						<div class="col-lg-3 col-md-6">
							<div class="widget widget-instagram">
								...
								<figure class="widget-body row">
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/01.jpg" alt="instagram 1" width="64" height="64" />
									</div>
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/02.jpg" alt="instagram 2" width="64" height="64" />
									</div>
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/03.jpg" alt="instagram 3" width="64" height="64" />
									</div>
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/04.jpg" alt="instagram 4" width="64" height="64" />
									</div>
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/05.jpg" alt="instagram 5" width="64" height="64" />
									</div>
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/06.jpg" alt="instagram 6" width="64" height="64" />
									</div>
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/07.jpg" alt="instagram 7" width="64" height="64" />
									</div>
									<div class="col-3">
										<img src="{{ asset('ui/frontend') }}/images/instagram/08.jpg" alt="instagram 8" width="64" height="64" />
									</div>
								</figure>
							</div>
							<!-- End Instagram -->
				...
				<div class="footer-bottom">
					<div class="footer-left">
						<figure class="payment">
							<img src="{{ asset('ui/frontend') }}/images/payment.png" alt="payment" width="159" height="29" />
						</figure>
					</div>
