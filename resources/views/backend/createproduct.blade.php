                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="inputEmail">Product Title</label>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="inputPasswordConfirm">Details</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" href="login.html">Add</a></div>
                                            </div>
                                        </form>
                                    </div>
